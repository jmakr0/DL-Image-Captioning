...
def resnet152_conv_layers():
    """Creates the ResNet152 architecture without the fully connected layers at the end.

    Thanks to mvoelk for providing the base version of this function:
...
class ResNet152(Model):
    ...
    def __init__(self, weights_path=None):
        img_input, x = resnet152_conv_layers()
...
class ResNet152Finetune(Model):
    ...
    def __init__(self, weights_path, num_classes):
        ...
        model = Model(img_input, x_fc)
        # now load weights for original layers
        model.load_weights(weights_path, by_name=True)
        ...
        x_newfc = Dense(num_classes, activation='softmax', name='fc_new_' + str(num_classes))(x_newfc)
